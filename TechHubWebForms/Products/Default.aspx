        ...
        <asp:Repeater ID="rptProducts" runat="server" OnItemCommand="rptProducts_ItemCommand">
            ...
            <ItemTemplate>
                <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1); transition: all 0.3s; cursor: pointer;"
                    ...
                    <div style="height: 220px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center; position: relative;">
                    ...
                    <div style="padding: 20px;">
                        ...
                        <p style="font-size: 14px; color: #64748b; margin-bottom: 15px; height: 40px; overflow: hidden; line-height: 1.4;">
                            <%# Eval("Description").ToString().Length > 60 ? Eval("Description").ToString().Substring(0, 60) + "..." : Eval("Description") %>
                        </p>
